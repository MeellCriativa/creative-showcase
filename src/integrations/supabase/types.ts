  ...
  public: {
    Tables: {
      ...
      radar_buscas: {
        ...
        Relationships: [
          {
            foreignKeyName: "radar_buscas_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
      ...
      radar_grupo_usuario: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "radar_grupo_usuario_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "users";
            referencedColumns: ["id"];
      ...
      radar_lista_grupos: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "radar_lista_grupos_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "users";
            referencedColumns: ["id"];
      ...
      radar_listas: {
        ...
        Relationships: [
          {
            foreignKeyName: "radar_listas_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "users";
            referencedColumns: ["id"];
